  ...
  render(){
    ...
    return(
      <div className="div-principalMenuCentral">
        ...
        <a href="/">
          <img className="img-menuCentral-header" src="http://chapala.tecmm.edu.mx/imagenes/header.jpg"/>
        </a>
        <img className="img-menuCentral-nombre" src="http://chapala.tecmm.edu.mx/imagenes/chapala.png"/>
